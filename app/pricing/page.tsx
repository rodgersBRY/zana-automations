    ...
    <div className="pt-24 pb-24 bg-brand-bg min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-col gap-5 mb-16 text-center max-w-2xl mx-auto">
          ...
          <h1 className="font-display font-extrabold text-5xl sm:text-6xl text-brand-text tracking-tight">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {PRICING_TIERS.map((tier) => (
            <div
              key={tier.name}
              className={`relative flex flex-col bg-brand-surface border rounded-2xl p-8 ${
                tier.highlighted
